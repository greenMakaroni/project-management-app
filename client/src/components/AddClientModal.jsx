...
export default function AddClientModal() {
    ...
    return (
        <>
            <button type="button" className="btn btn-success" data-bs-toggle="modal" data-bs-target="#addClientModal">
                        ...
                        <div className="modal-body">
                            <form onSubmit={onSubmit}>
                                ...
                                <div className="d-flex justify-content-between">
                                    <button className="btn btn-outline-danger" onClick={() => (setName(''), setEmail(''), setPhone(''))}> Reset </button>
